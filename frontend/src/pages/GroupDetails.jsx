              ...
              <ul className="list-group list-group-flush">
                ...
                {debts.map((d, i) => (
                  <li key={i} className="list-group-item small py-3">
                    ...
                    <div className="h5 mb-0 fw-bold text-dark">{d.amount.toFixed(2)} INR</div>
                  </li>
                ))}
              </ul>
            </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="text-end">
                            <div className={`small fw-bold ${b.balance >= 0 ? "text-success" : "text-danger"}`}>
                              {b.balance >= 0 ? "+" : ""}{b.balance.toFixed(2)} INR
                            </div>
                        ...
                        <div>
                          ...
                          <div className="d-flex flex-wrap gap-1">
                            {expense.splits.map(s => (
                               <span key={s.id} className="badge bg-light text-muted border fw-normal" style={{fontSize: '0.65rem'}}>
                                 {s.user.name}: {s.amount.toFixed(2)}
                               </span>
                            ))}
                          </div>
                        </div>
                        <div className="text-end">
                          <div className="h5 mb-0 fw-bold text-primary">{expense.amount.toFixed(2)} <span className="small fw-normal" style={{fontSize: '0.7rem'}}>INR</span></div>
